...
class TestGradients(unittest.TestCase):
    ...
    def test_gradient_tanh(self):
        ...
        # c.backward()
        c.to_device(DeviceType.CPU)
        draw_compute_graph(c, filename="tanh_graph", format="png")
    ...
    def test_gradient_mlp(self):
        ...
        draw_compute_graph(output, filename="mlp_output_graph", format="png")
        ...
        draw_compute_graph(output, filename="mlp_graph", format="png")
